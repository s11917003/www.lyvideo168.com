...
class HomeController extends Controller
{
    public function index()
    {
        return Admin::content(function (Content $content) {
            ...
            $content->description('平台資訊');

            $content->row(function ($row) {
                $row->column(3, new InfoBox('用戶數', 'users', 'aqua', '/admin/users', Users::count()));
                $row->column(3, new InfoBox('發文數', 'book', 'green', '/admin/postarticle', PostsArticle::count()));
