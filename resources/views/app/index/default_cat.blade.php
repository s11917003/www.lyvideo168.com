	...
	<div class="content-left">
		...
		<div class="contentbox">			
			...
			<div class="contentword-r">
				...
				<div class="digg" onclick="location.href='/p/90?focus=reply'"><i class="fas fa-comment"></i><span> {{$post->detail->count_cmt}}</span></div>
			</div>
		</div>
		@endforeach
			...
			<ul class="pagination">
				...
				@if ($lastPage < 4)
					@for ($i = 1; $i < $lastPage; $i++)
					 <li><a href="/{{$cate}}/{{ $i }}" @if ($currentPage == $i) class="active" @endif>{{ $i }}</a></li>
					@endfor 			
				@else
					@if ($currentPage >= 4)
					<li><a href="/1">1</a></li>
					<li><a href="javascript:void(0)">...</a>					
					<li><a href="/{{$cate}}/@php echo ($currentPage - 2); @endphp">@php echo ($currentPage - 2) @endphp</a></li>
					<li><a href="/{{$cate}}/@php echo ($currentPage - 1); @endphp">@php echo ($currentPage - 1) @endphp</a></li>
					<li><a href="/{{$cate}}/@php echo ($currentPage ); @endphp" class="active">@php echo ($currentPage ) @endphp</a></li>
