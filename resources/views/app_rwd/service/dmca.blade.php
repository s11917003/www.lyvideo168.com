...
@section('maincontent')
				<div class="rs-privacy">
					...
					<p>If you choose to request removal of content by submitting an infringement notification, please remember that you are initiating a legal process. <span style="color:red;">@lang('default.description')Do not make false claims. Misuse of this process may result in the suspension of your account or other legal consequences.</span></p>
					<p>You may notify @lang('default.description') of alleged copyright infringement <i>via</i> email to <a href="mailto:copyright@@lang('default.description')" target="_blank">copyright@@lang('default.description')</a>.</p>
					...
					<p>Please be aware that if you knowingly materially misrepresent that material or activity on @lang('default.description') is infringing your copyright, you may be held liable for damages (including costs and attorneys’ fees) under Section 512(f) of the DMCA.</p>
					<p>The copyright owner’s name will be published on @lang('default.description') in place of disabled content. This will become part of the public record of your DMCA Notice, along with your description of the work(s) allegedly infringed. All the information provided in a DMCA Notice, the actual DMCA Notice (including your personal information), or both may be forwarded to the uploader of the allegedly infringing content. By submitting a DMCA Notice, you consent to having your information revealed in this way.</p>
					<h2>Counter-Notification Procedures</h2>
					<p>If you have received a DMCA Notice and believe that material you posted on @lang('default.description') was removed or access to it was disabled by mistake or misidentification, you may file a counter-notification with us (a “<b>Counter-Notice</b>”). Counter notifications must be submitted by the video’s original uploader or an agent authorized to act on their behalf.</p>
					<p>Counter-notices must be sent to our designated agent:</p>
					<ul class="noListStyle">
					<li>Email: <a href="mailto:copyright@{{@lang('default.description')}}">copyright@@lang('default.description')</a></li>
					</ul>
					<p style="font-style:italic;">Please do not send other inquiries or requests to our designated copyright agent. Absent prior express permission, our designated copyright agent is not authorized to accept or waive service of formal legal process, and any agency relationship beyond that required to receive valid DMCA Notices or Counter-Notices (as defined below) is expressly disclaimed.</p>
					...
					<li>A statement that you consent to the jurisdiction of the U.S. Federal District Court for the judicial district in which you are located (or if you are outside the U.S., for any judicial district in which the operator of @lang('default.description') may be found), and that you will accept service of process from the person who originally provided us with the DMCA Notice or an agent of such person.</li>
					</ul>
