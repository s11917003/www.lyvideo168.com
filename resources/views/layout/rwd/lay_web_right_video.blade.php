<aside><div class="keyword">
	...
	<div class="keyword__content">
	  ...
	  <ul class="keyword__content-list" style="    margin: 0.1rem;">
		<li><a style='font-size: 15px;' href="/{{$lang}}/rank/1">{{__('ui.rank.week')}}</a></li>
		<li><a style='font-size: 15px;' href="/{{$lang}}/rank/2">{{__('ui.rank.month')}}</a></li>
	  </ul>
	</div>
  </div>
  </aside>
